 ...
 * 
 */
@WebServiceClient(name = "SayHelloService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8889/helo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOSERVICE_QNAME = new QName("http://service/", "SayHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8889/helo?wsdl");
    ...
    public SayHello getSayHelloPort() {
        return super.getPort(new QName("http://service/", "SayHelloPort"), SayHello.class);
    }
    ...
    public SayHello getSayHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "SayHelloPort"), SayHello.class, features);
    }
